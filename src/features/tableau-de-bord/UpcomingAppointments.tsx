...
function AppointmentRow({ appointment }: { appointment: Appointment }) {
  return (
    <li className="flex items-center justify-between border-t border-cream-200/70 px-6 py-4 first:border-t-0">
      <div>
      ...
      <span className="rounded-full bg-cream-100 px-3.5 py-1.5 text-sm font-semibold text-plum-800 shadow-neu-inset-sm">
